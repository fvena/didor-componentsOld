<template lang="pug">
  .popupDemo
    Demo(title="Uso Básico")
      az-row
        az-button(@click="zoom = true" size="small") zoom
        az-button(@click="fade = true" size="small") fade
        az-button(@click="flip = true" size="small") flip
        az-button(@click="door = true" size="small") door
